"""
Django settings for yardgro_backend project.
...
SECRET_KEY = 'django-insecure-9um#-q2w5atwntg$lf7@bl4o@*2+(oxu#+!tsq7jh%5z&#-p45'
...
# JWT settings
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=59),  # short lifetime for security.. expand or reduce as desired: (hours=12)etc
...
WSGI_APPLICATION = 'yardgro_backend.wsgi.application'
